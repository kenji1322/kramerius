...
public class NextSchedulerTask extends TimerTask {
    ...
    public NextSchedulerTask(LRProcessManager lrProcessManager,
        ...
        try {
            ...
            if (!plannedProcess.isEmpty()) {
                ...
                if (runningProcesses < allowRunningProcesses()) {
                    ...
                    lrProcess.startMe(false,
                            this.processScheduler.getApplicationLib(),
    ...
    private int allowRunningProcesses() {
        String aProcess = KConfiguration.getInstance().getProperty(
